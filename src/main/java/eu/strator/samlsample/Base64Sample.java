...
/**
 * Base64 encoder which is a reduced version of Robert Harder's public domain implementation. See <a
 * href="http://iharder.net/base64">http://iharder.net/base64</a> for more information.
 * <p>
 * For internal use only.
 */
public final class Base64Sample {
     ...
     * @see Base64Sample#DO_BREAK_LINES
    ...
    private static byte[] decode(byte[] source, int off, int len, int options) {
        ...
        for (i = off; i < off + len; i++) { // Loop through source
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) {
                ...
                throw new InvalidBase64CharacterException(String.format("Bad Base64 input character '%c' in array position %d", source[i], i));
            }
        }
